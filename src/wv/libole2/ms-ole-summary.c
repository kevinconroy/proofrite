...
#define TYPE_TIME       0x40		/*  64, VT_FILETIME,	64-bit wvFILETIME structure  */
 ...
 *
 *  Convert a wvFILETIME format to unixtime
 *  wvFILETIME is the number of 100ns units since January 1, 1601.
 ...
 * @high_time: FIXME
 * 
 * Converts a wvFILETIME format to unixtime. wvFILETIME is the number of 100ns units
 ...
 * @time_low: FIXME
 * 
 * Converts a unixtime format to wvFILETIME. wvFILETIME is the number of 100ns units
 * since January 1, 1601. unixtime is the number of seconds since January 1,
 * 1970.
 **/

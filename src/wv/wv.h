...
/*Wine Portions Begin*/
    ...
    void wvGetPANOSE (wvPANOSE * panose, wvStream * fd);
    void wvInitPANOSE (wvPANOSE * item);


/*
 * The wvFONTSIGNATURE tells which Unicode ranges and which code pages
 ...
 */
    ...
    void wvGetFONTSIGNATURE (wvFONTSIGNATURE * fs, wvStream * fd);
    void wvInitFONTSIGNATURE (wvFONTSIGNATURE * fs);
...
//endif				/* _FILETIME_ */
    ...
    void wvGetFILETIME (wvFILETIME * ft, wvStream * fd);
    void wvInitFILETIME (wvFILETIME * ft);

    time_t wvDOSFS_FileTimeToUnixTime (const wvFILETIME * filetime,
				       U32 * remainder);
    int wvFileTimeToDosDateTime (const wvFILETIME * ft, U16 * fatdate,
				 U16 * fattime);
/*Wine Portions End*/
...
/* FBSE - File Blip Store Entry */
	...
	wvRECT m_rcBounds;	/* Boundary of metafile drawing commands */
	wvPOINT m_ptSize;		/* Size of metafile in EMUs */
...
/* FDG - File DG */
    ...
    typedef wvRECT FAnchor, FChildAnchor, FClientAnchor;
...
/* begin temp */
    ...
    void wvGetBITMAP (wvBITMAP * bmp, wvStream * fd);

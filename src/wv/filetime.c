...
void
wvGetFILETIME (wvFILETIME * ft, wvStream * fd)
{
...
int
wvFileTimeToDosDateTime (const wvFILETIME * ft, U16 * fatdate, U16 * fattime)
{
 ...
 *
 * Convert a wvFILETIME format to Unix time.
 * If not NULL, 'remainder' contains the fractional part of the filetime,
 * in the range of [0..9999999] (even if time_t is negative).
 */
time_t
wvDOSFS_FileTimeToUnixTime (const wvFILETIME * filetime, U32 * remainder)
{

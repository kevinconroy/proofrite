...
GR_Graphics * XAP_Win32Dialog_Print::getPrinterGraphicsContext(GR_Win32InkOverlay *inkOverlay)
{
	...
	GR_Win32Graphics * pGraphics = new GR_Win32Graphics(m_pPersistPrintDlg->hDC,&m_DocInfo, m_pApp, inkOverlay);
	return pGraphics;
}

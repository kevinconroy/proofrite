...
void XAP_Win32FrameImpl::_initialize(void)
{
  ...
  m_pTablet = new EV_Win32Tablet(pEEM);
  UT_return_if_fail(m_pTablet);
}
                                              ...
                                              UT_sint32 x, UT_sint32 y)
{
  ...
  if (m_pWin32Popup && m_pWin32Popup->synthesizeMenuPopup(getFrame()))
  {
    ...
    EV_Win32Tablet *pWin32Tablet = static_cast<EV_Win32Tablet *>(m_pTablet);
    pWin32Tablet->reset();
  }
...
LRESULT CALLBACK XAP_Win32FrameImpl::_FrameWndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
  ...
  if (!f)
  {
   ...
   // UT_DEBUGMSG(("KMC: XAP_Win32FrameImpl::_FrameWndProc(nada)\n"));
  ...
  case WM_SETFOCUS:
    ...
    {
      //KMC: tracing windows messages into abiword to try and fix refresh problems
      // UT_DEBUGMSG(("KMC: XAP_Win32FrameImpl::_FrameWndProc(WM_SETFOCUS)\n"));
  ...
  case WM_DRAWITEM: 
    {
      //KMC: tracing windows messages into abiword to try and fix refresh problems
      //UT_DEBUGMSG(("KMC: XAP_Win32FrameImpl::_FrameWndProc(WM_DRAWITEM)\n"));
    ...
    case RBN_HEIGHTCHANGE:
      {
        ...
        //KMC: tracing windows messages into abiword to try and fix refresh problems
        //UT_DEBUGMSG(("KMC: XAP_Win32FrameImpl::_FrameWndProc(WM_NOTIFY - RBN_HEIGHTCHANGE)\n"));
    ...
    case NM_CUSTOMDRAW:
      {
        ...
        //KMC: tracing windows messages into abiword to try and fix refresh problems
        //UT_DEBUGMSG(("KMC: XAP_Win32FrameImpl::_FrameWndProc(WM_SIZEWM_NOTIFY - NM_CUSTOMDRAW)\n"));
  ...
  case WM_SIZE:
    {
      ...
      //KMC: tracing windows messages into abiword to try and fix refresh problems
      //UT_DEBUGMSG(("KMC: XAP_Win32FrameImpl::_FrameWndProc(WM_SIZE)\n"));
  ...
  //KMC: tracing windows messages into abiword to try and fix refresh problems
  //UT_DEBUGMSG(("KMC: XAP_Win32FrameImpl::_FrameWndProc(default)\n"));

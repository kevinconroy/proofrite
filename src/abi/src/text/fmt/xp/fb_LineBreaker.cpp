...
bool fb_LineBreaker::splitAtNextNonBlank(fp_Run *pCurrentRun) {
	return _splitAtNextNonBlank(pCurrentRun);
}
...
void fb_LineBreaker::splitRunAt(fp_Run *pCurrentRun, fp_RunSplitInfo &splitInfo)
{
	this->_splitRunAt(pCurrentRun, splitInfo);
}

...
#ifndef IE_IMP_TABIWORD_1_H
#define IE_IMP_TABIWORD_1_H
...
class ABI_EXPORT IE_Imp_TAbiWord_1_Sniffer : public IE_ImpSniffer
{
	friend class IE_Imp;

public:
	IE_Imp_TAbiWord_1_Sniffer();
	virtual ~IE_Imp_TAbiWord_1_Sniffer() {}
...
class ABI_EXPORT IE_Imp_TAbiWord_1 : public IE_Imp_XML
{
public:
    IE_Imp_TAbiWord_1(PD_Document * pDocument);

    virtual ~IE_Imp_TAbiWord_1();

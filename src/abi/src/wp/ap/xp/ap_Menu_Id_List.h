...
// KMC: INK
menuitem(INK)
menuitem(INK_ANNOTATE_WITH_INK)
menuitem(INK_COLOR)
menuitem(INK_COLOR_BLACK)
menuitem(INK_COLOR_RED)
menuitem(INK_COLOR_BLUE)
menuitem(INK_COLOR_YELLOW)
menuitem(INK_COLOR_ORANGE)
menuitem(INK_COLOR_GREEN)
menuitem(INK_WIDTH)
menuitem(INK_WIDTH_SMALLEST)
menuitem(INK_WIDTH_SMALL)
menuitem(INK_WIDTH_MEDIUM)
menuitem(INK_WIDTH_LARGE)
menuitem(INK_WIDTH_LARGEST)
menuitem(INK_PEN_TYPE)
menuitem(INK_TYPE_BALLPOINT)
menuitem(INK_TYPE_HIGHLIGHTER)
menuitem(INK_TYPE_MARKER)

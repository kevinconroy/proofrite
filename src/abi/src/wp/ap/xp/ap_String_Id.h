...
// KMC: INK
dcl(MENU_LABEL_INK, "&Ink")
dcl(MENU_LABEL_INK_ANNOTATE_WITH_INK,"&Annote With Ink")
dcl(MENU_LABEL_INK_COLOR,"&Color")
dcl(MENU_LABEL_INK_COLOR_BLACK,"&Black")
dcl(MENU_LABEL_INK_COLOR_RED,"&Red")
dcl(MENU_LABEL_INK_COLOR_BLUE,"B&lue")
dcl(MENU_LABEL_INK_COLOR_YELLOW,"&Yellow")
dcl(MENU_LABEL_INK_COLOR_ORANGE,"&Orange")
dcl(MENU_LABEL_INK_COLOR_GREEN,"&Green")
dcl(MENU_LABEL_INK_WIDTH,"&Width")
dcl(MENU_LABEL_INK_WIDTH_SMALLEST,"S&mallest")
dcl(MENU_LABEL_INK_WIDTH_SMALL,"&Small")
dcl(MENU_LABEL_INK_WIDTH_MEDIUM,"&Medium")
dcl(MENU_LABEL_INK_WIDTH_LARGE,"&Large")
dcl(MENU_LABEL_INK_WIDTH_LARGEST,"L&argest")
dcl(MENU_LABEL_INK_PEN_TYPE,"&Pen Type")
dcl(MENU_LABEL_INK_TYPE_BALLPOINT,"&Ballpoint")
dcl(MENU_LABEL_INK_TYPE_HIGHLIGHTER,"&Highlighter")
dcl(MENU_LABEL_INK_TYPE_MARKER,"&Marker")
...
// KMC: INK
dcl(MENU_STATUSLINE_INK,"TabletPC Options")
dcl(MENU_STATUSLINE_INK_ENABLE,"Turns the document into an inkable area.")
dcl(MENU_STATUSLINE_INK_DISABLE,"Turns the document into a non-inkable area.")
dcl(MENU_STATUSLINE_INK_ANNOTATE_WITH_INK,"")
dcl(MENU_STATUSLINE_INK_COLOR,"")
dcl(MENU_STATUSLINE_INK_COLOR_BLACK,"")
dcl(MENU_STATUSLINE_INK_COLOR_RED,"")
dcl(MENU_STATUSLINE_INK_COLOR_BLUE,"")
dcl(MENU_STATUSLINE_INK_COLOR_YELLOW,"")
dcl(MENU_STATUSLINE_INK_COLOR_ORANGE,"")
dcl(MENU_STATUSLINE_INK_COLOR_GREEN,"")
dcl(MENU_STATUSLINE_INK_WIDTH,"")
dcl(MENU_STATUSLINE_INK_WIDTH_SMALLEST,"")
dcl(MENU_STATUSLINE_INK_WIDTH_SMALL,"")
dcl(MENU_STATUSLINE_INK_WIDTH_MEDIUM,"")
dcl(MENU_STATUSLINE_INK_WIDTH_LARGE,"")
dcl(MENU_STATUSLINE_INK_WIDTH_LARGEST,"")
dcl(MENU_STATUSLINE_INK_PEN_TYPE,"")
dcl(MENU_STATUSLINE_INK_TYPE_BALLPOINT,"")
dcl(MENU_STATUSLINE_INK_TYPE_HIGHLIGHTER,"")
dcl(MENU_STATUSLINE_INK_TYPE_MARKER,"")

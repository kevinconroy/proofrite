...
//		MenuItem(AP_MENU_ID_VIEW_HEADFOOT)
	...
	// KMC: INK
	BeginSubMenu(AP_MENU_ID_INK)
		MenuItem(AP_MENU_ID_INK_ANNOTATE_WITH_INK)
		Separator()
		BeginSubMenu(AP_MENU_ID_INK_COLOR)
			MenuItem(AP_MENU_ID_INK_COLOR_BLACK)
			MenuItem(AP_MENU_ID_INK_COLOR_RED)
			MenuItem(AP_MENU_ID_INK_COLOR_BLUE)
			MenuItem(AP_MENU_ID_INK_COLOR_YELLOW)
			MenuItem(AP_MENU_ID_INK_COLOR_ORANGE)
			MenuItem(AP_MENU_ID_INK_COLOR_GREEN)
		EndSubMenu()
		BeginSubMenu(AP_MENU_ID_INK_WIDTH)
			MenuItem(AP_MENU_ID_INK_WIDTH_SMALLEST)
			MenuItem(AP_MENU_ID_INK_WIDTH_SMALL)
			MenuItem(AP_MENU_ID_INK_WIDTH_MEDIUM)
			MenuItem(AP_MENU_ID_INK_WIDTH_LARGE)
			MenuItem(AP_MENU_ID_INK_WIDTH_LARGEST)
		EndSubMenu()
		BeginSubMenu(AP_MENU_ID_INK_PEN_TYPE)
      MenuItem(AP_MENU_ID_INK_TYPE_BALLPOINT)
      MenuItem(AP_MENU_ID_INK_TYPE_HIGHLIGHTER)
      MenuItem(AP_MENU_ID_INK_TYPE_MARKER)
		EndSubMenu()
	EndSubMenu()

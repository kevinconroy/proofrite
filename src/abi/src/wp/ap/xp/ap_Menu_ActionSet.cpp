...
//	_s(AP_MENU_ID_VIEW_HEADFOOT,	0,0,1,	"viewHeadFoot",		ap_GetState_View,		NULL);
	...
	// KMC: INK
	_s(AP_MENU_ID_INK,										1,0,0,	NULL,										NULL,													NULL);
	_s(AP_MENU_ID_INK_ANNOTATE_WITH_INK,	0,0,1,	"inkToggleAnnotation",	ap_GetState_InkAnnotation,		NULL);
	_s(AP_MENU_ID_INK_COLOR,							1,0,0,	NULL,										NULL,													NULL);
	_s(AP_MENU_ID_INK_COLOR_BLACK,				0,0,1,	"inkColorBlack",				ap_GetState_InkColor,					NULL);
	_s(AP_MENU_ID_INK_COLOR_RED,					0,0,1,	"inkColorRed",					ap_GetState_InkColor,					NULL);
	_s(AP_MENU_ID_INK_COLOR_BLUE,					0,0,1,	"inkColorBlue",					ap_GetState_InkColor,					NULL);
	_s(AP_MENU_ID_INK_COLOR_YELLOW,				0,0,1,	"inkColorYellow",				ap_GetState_InkColor,					NULL);
	_s(AP_MENU_ID_INK_COLOR_ORANGE,				0,0,1,	"inkColorOrange",				ap_GetState_InkColor,					NULL);
	_s(AP_MENU_ID_INK_COLOR_GREEN,				0,0,1,	"inkColorGreen",				ap_GetState_InkColor,					NULL);
	_s(AP_MENU_ID_INK_WIDTH,							1,0,0,	NULL,										NULL,													NULL);
	_s(AP_MENU_ID_INK_WIDTH_SMALLEST,			0,0,1,	"inkWidthSmallest",			ap_GetState_InkWidth,					NULL);
	_s(AP_MENU_ID_INK_WIDTH_SMALL,				0,0,1,	"inkWidthSmall",				ap_GetState_InkWidth,					NULL);
	_s(AP_MENU_ID_INK_WIDTH_MEDIUM,				0,0,1,	"inkWidthMedium",				ap_GetState_InkWidth,					NULL);
	_s(AP_MENU_ID_INK_WIDTH_LARGE,				0,0,1,	"inkWidthLarge",				ap_GetState_InkWidth,					NULL);
	_s(AP_MENU_ID_INK_WIDTH_LARGEST,			0,0,1,	"inkWidthLargest",			ap_GetState_InkWidth,					NULL);
	_s(AP_MENU_ID_INK_PEN_TYPE,						1,0,0,	NULL,										NULL,													NULL);
	_s(AP_MENU_ID_INK_TYPE_BALLPOINT,			0,0,1,	"inkTypeBallpoint",			ap_GetState_PenType,					NULL);
	_s(AP_MENU_ID_INK_TYPE_HIGHLIGHTER,		0,0,1,	"inkTypeHighlighter",		ap_GetState_PenType,					NULL);
	_s(AP_MENU_ID_INK_TYPE_MARKER,	  		0,0,1,	"inkTypeMarker",			  ap_GetState_PenType,					NULL);

...
SOURCE="..\libiconv\libcharset\include\libcharset.h.msvc-shared"

!IF  "$(CFG)" == "libiconv - Win32 Debug"

# Begin Custom Build
InputPath="..\libiconv\libcharset\include\libcharset.h.msvc-shared"

"..\libiconv\libcharset\include\libcharset.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy ..\libiconv\libcharset\include\libcharset.h.msvc-shared ..\libiconv\libcharset\include\libcharset.h
...
SOURCE=..\libiconv\include\libiconv.h.msvc

!IF  "$(CFG)" == "libiconv - Win32 Debug"

# Begin Custom Build
InputPath=..\libiconv\include\libiconv.h.msvc

"..\libiconv\include\libiconv.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy ..\libiconv\include\libiconv.h.msvc ..\libiconv\include\libiconv.h

...
dnl= abi_plugin_macro="ABIPGN_COQUILLE"
dnl= 
...
dnl= abi_plugin_desc="DocBook with Coquille header extension; DTD can be found here: http://www.infobi.com/dtd/coquille.dtd"
dnl=
